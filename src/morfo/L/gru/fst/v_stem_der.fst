...
start -> stem1       <te:>  [vc=[+ps,-cs],tm=prf];[vc=[+ps,-cs],tm=j_i,sp=2,-neg]
# also gemination of following consonant
start -> stem1       [t:]   [vc=[+ps,-cs],tm=imf];[vc=[+ps,-cs],tm=j_i,sp=1|3];[vc=[+ps,-cs],tm=j_i,sp=2,+neg]
