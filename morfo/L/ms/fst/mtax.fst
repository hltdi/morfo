...
### root
# These could all be combined into a single list since they're not
# distinguished in this FST
root -> root0  +siv_root_free+       
root -> root0  +siv_root_bound+      
root -> root0  +n_root_free+         
root -> root0  +n_root_bound+        
root -> root0  +tv_root_free+        
root -> root0  +tv_root_bound+       
root -> root0  +iv_root_bound+       
root -> root0  +iv_dyn_root_bound+   
root -> root0  +iv_dyn_root_free+    
root -> root0  +prep+                
root -> root0  +adv+
root -> root0  +misc+
root0 -> suf1  [+:]
